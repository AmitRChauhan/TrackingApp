...
@property (atomic, retain) UIView *indicator;
@property (atomic, retain) NSTimer *graceTimer;
@property (atomic, retain) NSTimer *minShowTimer;
@property (atomic, retain) NSDate *showStarted;
@property (atomic, assign) CGSize size;
@property (atomic, retain) UIView *animatedImageView;
...
-(void)setImageAnimation
{
    if (!animatedImageView) {
        animatedImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];

    }
    [animatedImageView setContentMode:UIViewContentModeCenter];
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.labelFont = [UIFont fontWithName:@"Avenir-Heavy" size:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName:@"Avenir-Medium" size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)layoutSubviews {
    ...
    CGRect indicatorF = animatedImageView.bounds;//indicator.bounds;
    ...
    animatedImageView.frame = indicatorF;
