...
#import "PasswordAuthenticationVC.h"
#import "MapScreenViewController.h"

@interface PasswordAuthenticationVC ()<UITextFieldDelegate>
{
...
@implementation PasswordAuthenticationVC
...
- (IBAction)nextBtnAction:(id)sender {
    ...
    [self performSegueWithIdentifier:@"loginToSWRevel" sender:nil];
